<%-- 
    ...
    Created on : Oct 17, 2013, 2:47:16 AM
...
<form action="searchhostel.jsp" method="get" name="Content">
<table class="Content">
<tr>
<td width="10%"></td>
...
{
    flag++;
     out.println("<table style='border-bottom:1px solid #e2e2e2' class='Content'><tr><td style='font-size:18px'><br><a href='Blog.jsp?Name="+rs.getString(1)+"&Blogid="+rs.getString(6)+"'>"+rs.getString(1)+"</a></td></tr><tr><td>Country : "+rs.getString(2)+"</td><td>State : "+rs.getString(3)+"</td><td>City : "+rs.getString(4)+"</td><td> Landmark : "+rs.getString(5)+"</td></tr></table>");
    //out.println("<br>inside while<br>");
