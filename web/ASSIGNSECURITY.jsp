<%-- 
    Document   : ASSIGNSECURITY
    Created on : Oct 22, 2013, 9:56:27 PM
...
int TenantID=0, Securitycharges;

     Securitycharges=Integer.parseInt(request.getParameter("Securitycharges").toString());
...
Statement s=con.createStatement();
String query="insert into Securitycharges(HostelID, TenantID, charge, Date) values('"+HostelID+"', '"+TenantID+"', '"+Securitycharges+"', '"+CurrentDate+"')";
...
{//this catch is for connection and drivers}
    //out.println(ex);
    out.println("<b><font color=''>'"+TenantEmail+"' is already given securuty charge.</font></b>");
}
     finally{con.close();}
     }
     else
